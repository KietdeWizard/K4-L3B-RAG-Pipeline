...
- [Evaluation result](group_project/evaluation/RESULT.md): kết quả đánh giá và so sánh A/B.
- [Individual report template](reports/INDIVIDUAL_REPORT.md): template báo cáo cá nhân.
- [Nguyen Minh Kiet's report](reports/2A202602373-KietNguyen.md): báo cáo đóng góp cá nhân.
